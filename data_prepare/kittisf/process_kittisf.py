...
# add if __name__ == '__main__': , prvent the over operation
# create a folder call training and note that path : [your_path]\training, such as --> D:\MasterAIBDDisseration\RawDataset\ 
# copy the path of data_prepare\kittisf\process_kittisf.py ,such as --> D:\MasterAIBDDisseration\OGC-main\data_prepare\kittisf\process_kittisf.py
# copy and paste this in terminal :python D:\MasterAIBDDisseration\OGC-main\data_prepare\kittisf\process_kittisf.py D:\MasterAIBDDisseration\RawDataset\training